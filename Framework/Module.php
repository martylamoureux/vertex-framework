...
class Module
{
    ...
    public static $assetFolderName = __CLASS__;
    ...
    {
        $classname = static::$assetFolderName;
    ...
    protected function loadTwig()
    {
        ...
        $this->internalTwig->addFunction(new \Twig_SimpleFunction('path', function ($action, $params = []) {
            return static::$app->generateUrl(strtolower(static::$app->getControllerName()), $action, $params);
        }));
        ...
        if (is_dir($this->customlTwigDirectory)) {
            ...
            $this->customTwig->addFunction(new \Twig_SimpleFunction('path', function ($action, $params = []) {
                return static::$app->generateUrl(strtolower(static::$app->getControllerName()), $action, $params);
            }));
